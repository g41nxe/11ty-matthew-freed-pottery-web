...
- image:
  ...
  body: |
    ...
    Bisque firings are best done slowly so that the remaining water turns to steam and escapes slowly so as not to force off sections from the wall of the pottery. When a piece is bisqued, it is then ready to be glazed.

    I mix all my glazes from scratch and have worked hard to developed my own unique palette of colours and textures. Once the glaze is applied, the piece goes back into the kiln for its final firing.
eleventyNavigation:
  key: ''
  order: 
---
